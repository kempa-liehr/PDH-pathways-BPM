...
consisting of four circular
steps, which are data access, knowledge discovery, knowledge
translation \& interpretation, as well as knowledge description, integration
\& sharing \cite{Frize2007_KM}.
Some examples of successful healthcare knowledge management might comprise
pediatric asthma care coordination \cite{Janevic2017_pathways}, the
characterization of the structure of a patient's care team
\cite{Thornton2015_pathways}, or care plan analysis for enhancing
communication and cancer care coordination \cite{Mayer2016_pathways}
to name just a view.
...
\cite{Iwata2013, Xu2017, Yan2017_pathways} and be associated with
performance metrics like length of stay \cite{Malin2018_pathways}.
