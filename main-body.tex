...
to understand the strengths and weaknesses of current pathway design,
...
rates \cite{Rotter2008_pathways}. Most of these indicators can be calculated or estimated using standard clinical timestamps.
...
performance \cite{Pearson2001_pathways}. PLS is analyzed based on pathway variants because patients that follow identical activity sequences are likely to have similar clinical diagnoses. 
...
\begin{equation}
 \hat{p} = \frac{N}{\sum\limits_{i=1}^N PLS_i} \approx 0.618	
\end{equation}
