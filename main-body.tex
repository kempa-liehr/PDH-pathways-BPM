...
%\subsubsection{Clinical Data Processing}
 A pathway variant is a unique activity sequence of a complete patient trace. The ProM plug-in \plugin{Explore Event Log} organizes patient traces into pathway variants, and the total number of pathway variants is an indicator of the level of clinical variation between patient traces. 
