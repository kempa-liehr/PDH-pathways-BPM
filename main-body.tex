...
%ProM provides the plug-in \plugin{Inductive Visual Miner} that
%visualizes healthcare pathway models from input clinical data almost instantaneously.
%It is the primary process-mining tool used in this study to construct
