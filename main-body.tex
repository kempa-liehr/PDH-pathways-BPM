...
Radiology/Pharmacy   &    \tabitem Theatre Encounter & String\\  /Lab/Anesthesia & \tabitem Clinical Activity & String\\  &\tabitem Clinical Activity Start Time  & Datetime\\
  \hline
Patient Demographics    &    \tabitem Theatre Encounter & String\\(specific to appendicitis patients)  &\tabitem Patient Age & Integer\\  &\tabitem Patient Gender  & String\\  &\tabitem Patient Ethnicity  & String\\
  \hline
  \hline
\end{tabular}
\end{table}
