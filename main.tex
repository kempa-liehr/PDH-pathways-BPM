...
design a process mining pipeline for healthcare pathway discovery and enrichment using hospital records.
The efficacy of combining learned healthcare pathways with
probabilistic machine learning models is demonstrated via a case study that
applies the proposed process mining pipeline to discover appendicitis
pathways from hospital records.
Machine learning methodologies based on probabilistic programming are utilized to explore pathway features that influence patient recovery time.
...
The proposed pipeline for healthcare pathway discovery  has the
potential to support the development of probabilistic machine learning models to further relate healthcare pathways to performance indicators such as patient recovery time. 
